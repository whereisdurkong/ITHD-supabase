    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const res1 = await supabase.from('ticket_master').select('*');
    ...
    const getCategoryChartData = () => {
        if (filterType === "perMonth" && monthlyData.length > 0) {
            return {
                ...
                datasets: ["hardware", "network", "application", "system"].map((category, index) => ({
                    label: category,
    ...
    return (
        <div>
            ...
            {showChart && viewMode === "subcategory" && (
                ...
                >
                    {filterType === "perMonth" ? (
                        ["hardware", "network", "application", "system"].map((category, i) => {
