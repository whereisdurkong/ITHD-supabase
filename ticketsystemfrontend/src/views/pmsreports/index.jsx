...
export default function PMSReport() {
    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                ...
                const res = await supabase.from('pmsticket_master').select('*');
                const data = res.data || [];
    ...
    const handleDownloadExcel = async () => {
        ...
        const ticketsWithDetails = await (async () => {
            ...
            for (const ticket of ticketsToExport) {
                try {
                    ...
                    const response = await supabase.from('users_master').select('*').eq('user_name', ticket.pmsticket_for).single();
        ...
        try {
            ...
            const tatRes = await supabase.from('pmstat_master').select('*')
