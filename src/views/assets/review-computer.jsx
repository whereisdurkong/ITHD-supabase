    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                ...
                const res = await supabase.from('users_master').select('*').eq('user_name', createdby).single();
    ...
    return (
        <Container fluid className="pt-100" style={{ background: 'linear-gradient(to bottom, #ffe798ff, #b8860b)', minHeight: '100vh', paddingTop: '100px' }}>
                        ...
                        <Card className="p-4 shadow-sm">
                            <div
                                ...
                                <div className="text-start">
                                    <h4 style={{ margin: 0 }}>Review Computer</h4>
                                    <h6
                                        title='asset logs'
                                        style={{
                                            margin: 0,
            ...
            <Modal show={showArchiveModal} onHide={() => setShowArchiveModal(false)} centered>
                ...
                <Modal.Body>
                    Are you sure you want to archive this desktop?
                </Modal.Body>
                <Modal.Footer>
